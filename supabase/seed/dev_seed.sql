...
SELECT CASE WHEN current_setting('dev_seed', true) = 'true' THEN
    ...
    INSERT INTO public.avatar_catalog(id, display_name, storage_path, category, sort_order, bg_color) VALUES
        ('apachiy-default-1', 'Apachiy Blue', 'default-blue.svg',   'default', 1, '#1E88E5'),
        ('apachiy-default-2', 'Apachiy Orange', 'default-orange.svg','default', 2, '#FF9800'),
        ('apachiy-default-3', 'Apachiy Green',  'default-green.svg', 'default', 3, '#43A047'),
        ('apachiy-default-4', 'Apachiy Red',    'default-red.svg',   'default', 4, '#E53935'),
        ('apachiy-default-5', 'Apachiy Purple', 'default-purple.svg','default', 5, '#8E24AA'),
        ('apachiy-default-6', 'Apachiy Cyan',   'default-cyan.svg',  'default', 6, '#00ACC1')
